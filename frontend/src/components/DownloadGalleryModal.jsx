...
const DownloadGalleryModal = ({ isOpen, onClose, onConfirm, downloadOptions, setDownloadOptions }) => {
      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content">
          <div className="modal-header bg-primary white">
            <h4 className="modal-title" id="myModalLabel10">DOWNLOAD PHOTOS</h4>
          </div>
          <div className="modal-body">
            <fieldset className="form-group floating-label-form-group">
              <label>CHOOSE DOWNLOAD SIZE</label>
              <select
          ...
          <div className="modal-footer">
            ...
            <button type="button" className="btn btn-outline-primary" onClick={onConfirm}>Start Download</button>
          </div>
        </div>
      </div>
    </div>
